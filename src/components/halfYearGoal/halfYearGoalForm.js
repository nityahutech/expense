...
const HalfYearGoalForm = (props) => {
    ...
    const [empEditable, setEmpEditable] = useState(
        currentAppraisal.status === "empPending"
    );
    const [mgrEditable, setMgrEditable] = useState(
        currentAppraisal.status === "mgrPending" && props.hrMode == false
    );
    ...
    let intPersonalGrowthEmployeeRating =
        currentAppraisal.empPersonalGrowthRating;
    if (
        intPersonalGrowthEmployeeRating == 0 ||
        intPersonalGrowthEmployeeRating == null
    ) {
    ...
    let intProjectManagerRating =
        currentAppraisal.mgrOrganisationActivitiesRating;
    ...
    if (
        intPersonalGrowthManagerRating == 0 ||
        intPersonalGrowthManagerRating == null
    ) {
    ...
    const options = [
        ...
        {
            label: " Creating knowledge repositorys",
            value: "Creating knowledge repositorys",
        },
        {
            label: "  Implementing best practices",
            value: "Implementing best practices",
        },
    ...
    const optionsTwo = [
        ...
        {
            label: "  learning new technical skills",
            value: "learning new technical skills",
        },
        { label: "  Others", value: "others" },
    ];
    ...
    const onFinish = (values) => {
        ...
        AppraisalContext.updateMidYearAppraisal(
            currentAppraisal.id,
            appraisalDetail
        )
            .then((response) => {
                ...
                showNotification(
                    "success",
                    "Success",
                    "Appraisal successfully submited"
                );
    ...
    return (
        <Layout classname="layout-antd" style={{ backgroundColor: "white" }}>
            ...
            >
                ...
                >
                    <p className="page-time" style={{ display: "none" }}>
                        {" "}
                        {currDate} {currTime} <h3>Hutech Solution Pvt Ltd</h3>
                    </p>
                ...
                <Row gutter={[16, 16]} className="page-header">
                    <Col xs={{ span: 12 }} lg={{ span: 8 }}>
                        <div>
                            ...
                            <Text type="secondary">{currentAppraisal.empId}</Text>
                        </div>
                    </Col>
                    <Col xs={{ span: 12 }} lg={{ span: 8 }}>
                        <div>
                            ...
                            <Text type="secondary">{currentAppraisal.fname}</Text>
                        </div>
                    </Col>
                    <Col xs={{ span: 12 }} lg={{ span: 8 }}>
                        <div>
                            ...
                            <Text type="secondary">{currentAppraisal.designation} </Text>
                        </div>
                    </Col>
                    <Col xs={{ span: 12 }} lg={{ span: 8 }}>
                        <div>
                            <div style={{ fontWeight: "600", fontSize: "15px" }}>Date</div>

                            <Text type="secondary">{currentAppraisal.quarter}</Text>
                        </div>
                    </Col>
                    <Col xs={{ span: 12 }} lg={{ span: 8 }}>
                        <div>
                            ...
                            <Text type="secondary">{currentAppraisal.repManager} </Text>
                        </div>
                    </Col>

                </Row>
                <Row>
                    <Col><Button>Next</Button></Col>
                </Row>

                <Row gutter={[8, 8]}>
                    <Col xl={24} lg={24} md={24} sm={24} xs={24}>
                        <Form
                            className="appraisall-div"
                            style={{ width: "600px" }}
                            layout="vertical"
                            labelCol={{
                                span: 24,
                            ...
                            initialValues={{
                                ...
                                organizationalActivitiesDetail:
                                    currentAppraisal.organizationalActivitiesDetail,

                                //checkBox
                                empOrganizationalCheckBox:
                                    currentAppraisal.empOrganizationalCheckBox,
                                empPersonalCheckBox: currentAppraisal.empPersonalCheckBox,

                                //rating
                                empProjectActivitiesRating:
                                    currentAppraisal.empProjectActivitiesRating,
                                empOrganisationActivitiesRating:
                                    currentAppraisal.empOrganisationActivitiesRating,
                                empPersonalGrowthRating:
                                    currentAppraisal.empPersonalGrowthRating,

                                managerComment: currentAppraisal.managerComment,
                                mgrProjectActivitiesRating:
                                    currentAppraisal.mgrProjectActivitiesRating,
                                mgrOrganisationActivitiesRating:
                                    currentAppraisal.mgrOrganisationActivitiesRating,
                                mgrPersonalGrowthRating:
                                    currentAppraisal.mgrPersonalGrowthRating,
                            }}
                            fields={[]}
                            autoComplete="off"
                            form={form}
                        ...
                        >
                            <Divider orientation="left" orientationMargin={0}>
                                To Be Fill By Employee<span style={{ color: "red" }}> *</span>
                            </Divider>
                                        ...
                                        <div>
                                            {fields.map((field, index) => (
                                                <div key={field.key} style={{ marginBottom: "10px" }}>
                                                    ...
                                                    <Form.Item name={[index, "projectDetail"]}>
                                                        <FloatTextArea
                                                            className="textArea-ant-two"
                            ...
                            >
                                <div style={{ display: "flex", flexDirection: "column" }}>
                                    ...
                                    >
                                        <div>
                                            <Radio.Group
                                                disabled={!empEditable}
                                                defaultValue={intProjectEmployeeRating}
                                                buttonStyle="solid"
                                            >
                                                <Radio.Button
                                                    className="radio-one"
                                ...
                                <div
                                    style={{
                                        display: mgrEditable || props.hrMode ? "flex" : "none",
                                        flexDirection: "column",
                                    }}
                                >
                                    <Form.Item
                                    ...
                                    >
                                        <div>
                                            <Radio.Group
                                                defaultValue={intProjectManagerRating}
                                                buttonStyle="solid"
                                            >
                                                <Radio.Button style={{ marginRight: "5px" }} value="1">
                                                    1
                                                </Radio.Button>
                                                <Radio.Button style={{ marginRight: "5px" }} value="2">
                                                    2
                                                </Radio.Button>
                                                <Radio.Button style={{ marginRight: "5px" }} value="3">
                                                    3
                                                </Radio.Button>
                                                <Radio.Button style={{ marginRight: "5px" }} value="4">
                                                    4
                                                </Radio.Button>
                                                <Radio.Button style={{ marginRight: "5px" }} value="5">
                                                    5
                                                </Radio.Button>
                                            </Radio.Group>
                                        </div>
                            ...
                            <Form.Item
                                name="empOrganizationalCheckBox"
                                colon={false}
                            ...
                            >
                                <div>
                                    <Radio.Group
                                        disabled={!empEditable}
                                        defaultValue={intEmployeeRating}
                                        buttonStyle="solid"
                                    >
                                        <Radio.Button style={{ marginRight: "5px" }} value="1">
                                            1
                            ...
                            <Form.Item
                                name="empPersonalCheckBox"
                                valuePropName="checked"
                                initialValue={defaults}
                            >
                                <Checkbox.Group
                                    className="checkbox-field-one"
                                    style={{ display: "flex", flexDirection: "column" }}
                                    options={optionsTwo}
                                    initialValues={defaults}
                                    onChange={onChange}
                            ...
                            >
                                <div>
                                    <Radio.Group
                                        disabled={!empEditable}
                                        defaultValue={intPersonalGrowthEmployeeRating}
                                        buttonStyle="solid"
                                    >
                                        <Radio.Button style={{ marginRight: "5px" }} value="1">
                                            1
                            ...
                            {mgrEditable ? (
                                <Divider orientation="left" orientationMargin={0}>
                                    To Be Fill By Manager<span style={{ color: "red" }}> *</span>
                                </Divider>
                            ) : null}
                            <Form.Item
                                labelAlign="left"
                                style={{
                                    display: mgrEditable || props.hrMode ? "block" : "none",
                                    marginBottom: "10px",
                                    width: "100%",
                                }}
                                name="managerComment"
