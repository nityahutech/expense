...
function Document() {
  return (
    <div className="education">
      <Card className="document-tap-div" bordered={true} hoverable={true}>
        <Tabs tabPosition="left" defaultActiveKey="1" className="documents">
          ...
          <Tabs.TabPane tab="Background Status" key="4">
            <Background />
          </Tabs.TabPane>
        </Tabs>
      </Card>
