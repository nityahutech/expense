...
const Leave = () => {
  ...
  const onFinish = (values) => {
    ...
    let newLeaves = tempUser.map((leave) => {
      if (
        leave.leavetype?.toLowerCase() === values?.leaveNature.toLowerCase()
      ) {
        leave.leave -= 1;
      }
      return leave;
            ...
            >
              ...
              >
                <button
                  ...
                  style={{
                    marginRight: "5px",
                    backgroundColor: "rgba(204, 10, 10,0.2)",
                  }}
                >
                  <h5
                    style={{ color: "rgba(204, 10, 10, 1)" }}
                    className="rep-text"
                  >
                    Absent
                  </h5>
              ...
              >
                ...
                <button
                  ...
                  style={{
                    marginRight: "5px",
                    backgroundColor: "rgba(204, 204, 10,0.2)",
                  }}
                >
                  <h5
                    style={{ color: "rgba(204, 204, 10, 1)" }}
                    className="rep-text"
                  >
                    Official Holiday
                  </h5>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Select required placeholder="Select a option " allowClear>
                  {users.map((u) => (
                    <Option disabled={u.leave <= 0} value={u.leavetype}>
                      {u.leavetype}
                    </Option>
                  ))}
                </Select>
