            ...
            {isModalOpen && (
                <div className="modal" style={modal}>
                    <div style={modalContent}>
                        ...
                        <iframe style={modalContent2} className="modal-content" ref={iframeRef} src=''> </iframe>
                        <Button style={{ margin: '10px' }} type="primary" onClick={closeModal}>Close Modal</Button>
                    </div>
                </div>
            )}
