...
const dataSource = [
    {
        SL: '1',
        divisionname: 'East Marketing Division',
        divisiondescription: 'East marketing zone covers eastern part of India',
        action: '',
    },
    ...
    return (
        <>
            <Row style={{ display: 'flex', flexDirection: 'column', margin: '20px' }}>
                <Row>
                    <Col style={{ fontWeight: 600 }} span={24}>Division -  Sales and Marketing </Col>
                </Row>
                <Row>
                    <Col span={24}>Product sales and distibution & purchase</Col>
                </Row>
            </Row>
            <Table
                className="tableTab"
