...
function HrPaySlip() {
  ...
  const onTotalSalaryChange = () => {
    ...
    const newTotal = parseInt(basic || 0) + hra + parseInt(conveyance || 0) + parseInt(medical || 0) + parseInt(proffallowance || 0) + parseInt(specialallowance || 0) + parseInt(otherAllowance || 0) + parseInt(lta || 0) + parseInt(bonus || 0);
  ...
  const onTotalDeductionChange = () => {
    ...
    const Deduction = parseInt(tds || 0) + parseInt(esi || 0) + parseInt(pfer || 0) + parseInt(pfem || 0) + parseInt(profTax || 0) + parseInt(otherDeduction || 0)
  ...
  async function getSalaryData() {
    const allSalaryData = await EmployeeNetSalary.getSalary();
    console.log('aaa', allSalaryData,)

    setData(allSalaryData);
  ...
  return (
    <div>
      ...
      <div>
        <div className="Third" style={showPreview ? { background: 'rgb(227 227 227)' } : {}}>
          <h1 style={showPreview ? { display: 'flex', alignItems: 'center', justifyContent: 'center' } : { display: 'flex', alignItems: 'flex-end' }}>{showPreview ? 'Payroll Preview' : 'Payroll Setting'}</h1>
          <Form
            form={form}
            labelCol={{
            ...
            onFinish={onFinish}
          >
            <Row gutter={[48, 0]} type="flex" align="center" style={showPreview ? {} : { border: '1px solid #edecec', paddingTop: '10px', margin: '10px', borderRadius: '10px' }}   >

              <Col xs={24} sm={showPreview ? 24 : 6} md={showPreview ? 24 : 6} lg={showPreview ? 24 : 6}  >
                <Form.Item
              ...
              <Col Col xs={24} sm={showPreview ? 24 : 6} md={showPreview ? 24 : 6} lg={showPreview ? 24 : 6}>
                <Form.Item
                  name="totalDeduction"
            ...
            <h2 style={showPreview ? { display: 'flex', alignItems: 'center', justifyContent: 'center' } : { display: 'flex', alignItems: 'flex-end' }}> Earnings</h2>
            <Row gutter={[48, 0]} style={showPreview ? {} : { border: '1px solid #edecec', paddingTop: '10px', margin: '10px', borderRadius: '10px' }}>
              <Col xs={24} sm={showPreview ? 24 : 12} md={showPreview ? 24 : 8} lg={showPreview ? 24 : 8}  >
                <Form.Item
                  name="basic"
                  label="Basic"
                  style={showPreview ? { margin: '0px' } : { marginBottom: '20px' }}
              ...
              <Col xs={24} sm={showPreview ? 24 : 12} md={showPreview ? 24 : 8} lg={showPreview ? 24 : 8}  >
                ...
                >
                  {showPreview ? (<span>
                    {form.getFieldValue('conveyance')}</span>) : (
                    <Input
              ...
              <Col xs={24} sm={showPreview ? 24 : 12} md={showPreview ? 24 : 8} lg={showPreview ? 24 : 8}  >
                ...
                >
                  {showPreview ? (<span>
                    {form.getFieldValue('medical')}</span>) : (
                    <Input
                      maxLength={20}
              ...
              <Col xs={24} sm={showPreview ? 24 : 12} md={showPreview ? 24 : 8} lg={showPreview ? 24 : 8}    >
                ...
                >
                  {showPreview ? (<span>
                    {form.getFieldValue('proffallowance')}</span>) : (
                    <Input
                      maxLength={20}
                      onChange={onTotalSalaryChange}
              ...
              <Col xs={24} sm={showPreview ? 24 : 12} md={showPreview ? 24 : 8} lg={showPreview ? 24 : 8}    >
                ...
                >
                  {showPreview ? (<span>
                    {form.getFieldValue('specialallowance')}</span>) : (
                    <Input
                      maxLength={20}
                      onChange={onTotalSalaryChange}
              ...
              <Col xs={24} sm={showPreview ? 24 : 12} md={showPreview ? 24 : 8} lg={showPreview ? 24 : 8}  >
                ...
                >
                  {showPreview ? (<span>
                    {form.getFieldValue('otherAllowance')} </span>) : (
                    <Input
                      onChange={onTotalSalaryChange}
                      maxLength={20}
            ...
            <h2 style={showPreview ? { display: 'flex', alignItems: 'center', justifyContent: 'center' } : { display: 'flex', alignItems: 'flex-end' }}> Deductions</h2>
            <Row gutter={[48, 0]} style={showPreview ? {} : { border: '1px solid #edecec', paddingTop: '10px', margin: '10px', borderRadius: '10px' }} >
              <Col xs={24} sm={showPreview ? 24 : 12} md={showPreview ? 24 : 8} lg={showPreview ? 24 : 8}    >
                <Form.Item
                  name="tds"
              ...
              <Col xs={24} sm={showPreview ? 24 : 12} md={showPreview ? 24 : 8} lg={showPreview ? 24 : 8}     >
                ...
                >
                  {showPreview ? (<span>
                    {form.getFieldValue('profTax')} </span>) : (
                    <Input
                      maxLength={20}
                      onChange={onTotalDeductionChange}
                      // required
              ...
              <Col xs={24} sm={showPreview ? 24 : 12} md={showPreview ? 24 : 8} lg={showPreview ? 24 : 8}   >
                ...
                >
                  {showPreview ? (<span>
                    {form.getFieldValue('otherDeduction')} </span>) : (
                    <Input
                      maxLength={20}
                      // required
                      onChange={onTotalDeductionChange}
