...
const dataSource = [
    {
        SL: '1',
        departmentname: 'Sales Operation',
        departmentdescription: 'Manages day-to-day operations of sales organization...',
        action: '',
    },
    ...
    return (
        <>
            <Row style={{ display: 'flex', flexDirection: 'column', margin: '20px' }}>
                <Row>
                    <Col style={{ fontWeight: 600 }} span={24}>Department -  South sales Zone</Col>
                </Row>
                <Row>
                    <Col span={24}>Description here </Col>
                </Row>
            </Row>
